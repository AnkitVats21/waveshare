...
namespace COMP {
    ...
    static constexpr ComponentMask BLUETOOTH    = (1u << 23); ///< Pi BlueZ A2DP Bluetooth state
    static constexpr ComponentMask BT_COMPANION = BLUETOOTH;  ///< Backward-compatibility alias
